	...
	<div id="conteiner">
		...
		<div id="main">
			<div id="primary" style="margin-top:10px">
				...
				<aside id="secondary" class="sidebar-left">
				<?php 
                    $ShowImages = explode("&", $vehicleData['images']);  
                ?>
				   
				    
					<div class="widget">
						<img src="<?=$vehicleData['images'] == '' ? 'https://s7d1.scene7.com/is/image/hyundai/compare-vehicle-1225x619?wid=276&hei=156&fmt=png-alpha' : 'images/vehicles/'.$ShowImages[0]?>"
						style="width:100%; cursor: pointer;" alt="" class='zoomable'/>
						<img src="<?=$vehicleData['images'] == '' ? 'https://s7d1.scene7.com/is/image/hyundai/compare-vehicle-1225x619?wid=276&hei=156&fmt=png-alpha' : 'images/vehicles/'.$ShowImages[1]?>"
						style="width:30%;cursor: pointer;" alt="" class='zoomable'/>
						<img src="<?=$vehicleData['images'] == '' ? 'https://s7d1.scene7.com/is/image/hyundai/compare-vehicle-1225x619?wid=276&hei=156&fmt=png-alpha' : 'images/vehicles/'.$ShowImages[2]?>"
						style="width:30%;cursor: pointer;" alt="" class='zoomable'/>
							...
							<div class="product-info">
								...
								<div class="details">
									...
									<ul class="details-more">
										<li>Name: <?=$user['firstname']?> <?=$user['middlename']?> <?=$user['surname']?></li>
										<li>Contact: <?=$user['contact']?></li>
										<li>Email: <?=$user['email']?></li>
										<li>Type: <?=$user['user_type']?></li>
									</ul>
								</div>
					...
					<div class="widget">
						<h3 class="widget-title">
							<label style="margin-left:-5px">Description/Rules & Regulations</label>
						</h3>
						<div class="widget-content main-block product-widget-mini">
				...
				<div id="content" class="sidebar-middle">
					<div class="widget main-widget product-widget">
						...
						<?php 
							$ShowImages = explode("&", $vehicles['images']);  
						?>
						<div class="post">
							<div class="main-block_container">
								<div class="main-block">
									<div class="product-img">
										<img src="<?=$vehicles['images'] == '' ? 'https://s7d1.scene7.com/is/image/hyundai/compare-vehicle-1225x619?wid=276&hei=156&fmt=png-alpha' : 'images/vehicles/'.$ShowImages[0]?>"
						...
						<div class="widget">
							...
							<div class="post">
								<div style="padding:20px">
									...
									<p>Rent per day</p>
									<input type="text" disabled class="shortcode_input" style="width:100%"
