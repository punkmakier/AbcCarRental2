            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <img src="<?=empty($rows['requirement']) ? 'https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg' : '../../images/license/'.$rows['requirement']?>"
                                            style="width:100%" alt="" />
                                    </div>
                                        <a href="../../images/license/<?=$rows['requirement']?>" class="btn btn-primary btn-block btn-sm" download>Download</a>
                                </div>
                ...
                <div class="col-md-8 col-12">
                    ...
                    <div class="examle-wrap">
                        <h4 class="example-title">Customer Information</h4>
                        <div class="example">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" class="form-control">
                                                                <option value="0" <?=$rows['status'] == 0 ? 'selected' : ''?>>Pending</option>
                                                                <option value="1" <?=$rows['status'] == 1 ? 'selected' : ''?>>Approve</option>
