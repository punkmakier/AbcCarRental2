        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title" style="float: left;">Messages</h3>
                ...
                <div class="panel-body">
                    <div class="table-responsive all">
                        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <tbody>
                                <?php $i=1; foreach(get_all_req_message() as $owner) { ?>
                                    <tr>
                                        <td><?=$i++?></td>
                                        <td><?=$owner['sender']?></td>
                                        ...
                                        <td><?=$owner['message']?></td>
                                        <td><?=$owner['date']?></td>
                                        <td style="position: relative;"><a href="chat-admin-customer.php?reference=<?=($owner['reference'])?>&id=<?=($owner['CustomerID'])?>" id="<?=($owner['id'])?>" class="btnMessage"><i class="fa-solid fa-envelope" style="font-size: 1.3rem;"></i><?php if(checkMessageStatus($owner['id']) == 0) echo "<p style='position: absolute; right:0; top:0; background-color: red; width: 10px; height: 10px; border-radius: 50%;'></p>";?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
