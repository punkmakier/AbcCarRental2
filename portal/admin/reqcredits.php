        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title" style="float: left;">Request Credits</h3>
                ...
                <div class="panel-body">
                    <div class="table-responsive all">
                        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <tbody>
                                <?php $i=1; foreach(get_all_accounts_req_to_buy_credits_pendingStatus() as $owner) { ?>
                                    <tr>
                                        <td><?=$i++?></td>
                                        ...
                                        <td><?=$owner['c_status']?></td>
                                        <td>

                                            <?php if ($owner['user_type'] == 'Customer') { ?>
                                                <a href="customer-details.php?id=<?=($owner['customer_id'])?>&subscription=1"><i class="icon wb-pencil"></i></a>
                                            <?php }else{ ?>
                                                <a href="owner-details.php?id=<?=($owner['customer_id'])?>&subscription=1"><i class="icon wb-pencil"></i></a>
                                            <?php } ?>
