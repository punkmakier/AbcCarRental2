        ...
        <div class="page-content">
            <div class="panel">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title" style="float: left;">Approved Accounts</h3>
                ...
                <div class="panel-body">
                    <div class="table-responsive all">
                        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <tbody>
                                <?php $i=1; foreach(get_all_accounts_approved_list_all() as $owner) { ?>
                                    <tr>
                                        <td><?=$i++?></td>
                                        ...
                                        <td><?=$owner['status'] == 0 ? 'Inactive' : 'Approved'?></td>
                                        <td>

                                            <?php if ($owner['user_type'] == 'Customer') { ?>
                                                <a href="customer-details.php?id=<?=($owner['id'])?>"><i class="icon wb-pencil"></i></a>
                                            <?php }else{ ?>
                                                <a href="owner-details.php?id=<?=($owner['id'])?>"><i class="icon wb-pencil"></i></a>
                                            <?php } ?>
                    ...
                    <div class="table-responsive customers">
                        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <tbody>
                                <?php $i=1; foreach(get_all_accounts_approved_list_customers() as $owner) { ?>
                                    <tr>
                                        <td><?=$i++?></td>
                                        <td><?=$owner['firstname'].' '.$owner['middlename'].' '.$owner['surname']?></td>
                                        <td><?=$owner['username']?></td>
                    ...
                    <div class="table-responsive owners">
                        <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                            ...
                            <tbody>
                                <?php $i=1; foreach(get_all_accounts_approved_list_owners() as $owner) { ?>
                                    <tr>
                                        <td><?=$i++?></td>
                                        <td><?=$owner['firstname'].' '.$owner['middlename'].' '.$owner['surname']?></td>
                                        <td><?=$owner['username']?></td>
