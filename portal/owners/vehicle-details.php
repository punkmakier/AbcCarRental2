...
<head>
   ...
   <script>
       function submitForm(form){
          ...
          .then((isOkay) => {
              if (isOkay){
             window.location = "?delete=true&id=<?=$_GET['id']?>";
            }
          });
          return false;
       }
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <img src="<?=empty($vehicle['images']) ? 'https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg' : '../../images/vehicles/'.$ShowImages[0];?>"
                                            style="width:100%; cursor: pointer;" alt="" class='zoomable'/>
                                        <img src="<?=empty($vehicle['images']) ? 'https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg' : '../../images/vehicles/'.$ShowImages[1];?>"
                                        style="width:30%; cursor: pointer;" alt="" class='zoomable'/>
                                        <img src="<?=empty($vehicle['images']) ? 'https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg' : '../../images/vehicles/'.$ShowImages[2];?>"
                                        style="width:30%; cursor: pointer;" alt="" class='zoomable'/>
                                        <img src="<?=empty($vehicle['images']) ? 'https://upload.wikimedia.org/wikipedia/commons/1/14/No_Image_Available.jpg' : '../../images/vehicles/'.$ShowImages[3];?>"
                                        style="width:30%; cursor: pointer;" alt="" class='zoomable'/>
                                    </div>
                            ...
                            <form method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-12 text-right">
                                        <a href="?delete=true&id=<?=$_GET['id']?>" onclick="return submitForm(this);" class="btn btn-danger btn-sm">Delete</a>
